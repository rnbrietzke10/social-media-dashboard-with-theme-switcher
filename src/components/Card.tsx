...
const Paragraph = styled.p<{ scheme: string }>`
  color: ${props =>
    props.scheme === 'dark'
      ? 'var(--color-dark-text)'
...
const CardContainer = styled.div<{ scheme: string; icon: string }>`
  ...
  box-shadow: 0 3px 6px rgba(32, 32, 32, 0.1), 0 3px 6px rgba(32, 32, 32, 0.1);
...
export const Card: React.FC<CardProps> = ({
  ...
  return (
    <CardContainer scheme={theme} icon={icon}>
      ...
      <CardFollowers className='card__followers'>{followers}</CardFollowers>
